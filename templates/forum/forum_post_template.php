...
<div class='forum-caption-image' style='background: url(".THEME_ABS."images/forum-caption-bg.jpg) no-repeat center center; background-size: cover;'>
  <div class='forum-caption-image-inner'><h2>{FORUM_POST_CAPTION}</h2></div>
</div>
";
...
<div class='form-group'>
	<label for='name' class='col-sm-2 control-label'>".LAN_FORUM_3010."</label>
  <div class='col-sm-10'>{FORUM_POST_AUTHOR}</div>
</div>
<div class='form-group'>
	<label for='subject' class='col-sm-2 control-label'>".LAN_FORUM_3011."</label>
	<div class='col-sm-10'>{FORUM_POST_SUBJECT}</div>
</div>
<div class='form-group'>
	<label class='col-sm-2 control-label'>{FORUM_POST_TEXTAREA_LABEL}</label>
	<div class='col-sm-10'>
		{FORUM_POST_TEXTAREA}
...
<div class='form-group'>
	<label class='col-sm-2 control-label'>{FORUM_POST_OPTIONS_LABEL}</label>
	<div class='col-sm-10'>{FORUM_POST_OPTIONS}</div>
</div>
