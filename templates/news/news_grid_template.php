...
$NEWS_GRID_TEMPLATE['featured-news']['item'] = '
  <div class="col-md-3 col-sm-6 col-xs-12 featured-news-item">
    <div class="featured-news-header">
      <h4>{NEWS_TITLE}</h4>
    </div>
    {SETIMAGE: w=900&h=700&crop=1}
    {NEWS_IMAGE: type=tag}
    <span class="featured-news-overlay"></span> 
    <div class="featured-news-item-button">
      <a href="{NEWS_URL}"><i class="fa fa-link"></i></a>
    </div>                  
  </div>';
